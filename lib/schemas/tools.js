              ...
              properties: {
                type: {
                  ...
                  description:
                    ...
                    'table: tabel dengan border — headers (array string), rows (array of array; tiap elemen bisa string atau { type:"image", path, width, height, alignment } untuk gambar di sel), caption (opsional). ' +
                ...
                rows: {
                  type: 'array',
                  description: 'Khusus table: array of array, tiap inner array = 1 baris. ' +
                               'Tiap elemen bisa string (teks) ATAU object { type:"image", path, width, height, alignment } untuk gambar di dalam sel.',
                  items: {
                    type: 'array',
                    items: {
                      oneOf: [
                        { type: 'string' },
                        {
                          ...
                          required: ['type', 'path'],
                          properties: {
                            type:      { type: 'string', enum: ['image'], description: 'Harus "image".' },
                            path:      { type: 'string', description: 'Path absolut ke file PNG/JPG.' },
                            width:     { type: 'number', description: 'Lebar gambar dalam piksel (default 150).' },
                            height:    { type: 'number', description: 'Tinggi gambar dalam piksel (default 100).' },
                            alignment: { type: 'string', description: 'center | left | right (default center).' },
                          },
                        },
                      ],
                    },
